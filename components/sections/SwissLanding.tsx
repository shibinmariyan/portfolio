            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        <m.div variants={itemVariants} className="flex flex-wrap gap-4 mb-10">
                            <a
                                href="#contact"
                        ...
                        <m.div variants={itemVariants}>
                            <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 mb-4 flex items-center gap-2">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-4">
                        ...
                        <m.div variants={itemVariants} className="glass-card rounded-full py-3 px-5 flex items-center justify-between mb-6 mt-6">
                        ...
                        >
                            {/* Architecture */}
                            <m.div variants={itemVariants} className="p-3 rounded-lg bg-primary-50 dark:bg-primary-950/20 border border-primary-100 dark:border-primary-900/30">
                            ...
                            {/* Frontend */}
                            <m.div variants={itemVariants} className="p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30">
                            ...
                            {/* Backend */}
                            <m.div variants={itemVariants} className="p-3 rounded-lg bg-purple-50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/30">
                            ...
                            {/* DevOps */}
                            <m.div variants={itemVariants} className="p-3 rounded-lg bg-indigo-50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/30">
