      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="lg:col-span-4">
            ...
            <motion.p variants={itemVariants} className="text-xl text-neutral-500 max-w-sm">
          ...
          <div className="lg:col-span-8 space-y-12">
            {portfolioData.experience.map((exp, index) => {
              ...
              return (
                <motion.div key={index} variants={itemVariants} className="group relative pl-8 border-l border-neutral-200 hover:border-primary-500 transition-colors duration-300">
                  <div className="absolute -left-1.5 top-0 w-3 h-3 rounded-full bg-neutral-200 group-hover:bg-primary-500 transition-colors duration-300" />
                  ...
                  <ul className="space-y-2">
                    {exp.description.map((desc, i) => (
                      <li key={i} className="text-neutral-600 leading-relaxed flex items-start gap-2 text-sm sm:text-base">
